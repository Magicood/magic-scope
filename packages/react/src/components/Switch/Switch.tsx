 ...
 * 支持右侧文字 children、轨道内两端图标(checked/unchecked)、loading(滑块转旋转符文、aria-busy);
      ...
      <label className={labelClasses}>
        ...
        <span className={trackClasses} aria-hidden="true">
          ...
          <span className={thumbClasses}>
            {/* 纯装饰旋转符文;loading 语义由 input 的 aria-busy 表达,故不重复加 role/label */}
