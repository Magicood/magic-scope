...
// 复制成功瞬间触发魔法 glow 一闪(受全局光影开关 / reduced-motion 调制),按钮文案走 i18n。
const SPELL = 'fireball --power=9 --target=void';
...
export default function Demo() {
  ...
  return (
    <div style={{ display: 'grid', gap: '1.1rem', maxInlineSize: 'min(520px, 100%)' }}>
      ...
      {/* 自定义要复制的文本 + 成功回调 */}
      <Paragraph tone="accent" copyable={{ text: SPELL, onCopy: setLastCopied }}>
        点这段会复制施法指令:<code>{SPELL}</code>
      </Paragraph>
