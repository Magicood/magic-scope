...
export default function Demo() {
  return (
    <div style={{ display: 'grid', gap: '1rem', maxInlineSize: 'min(560px, 100%)' }}>
      ...
      <Blockquote variant="card" tone="warning" quoteMark cite="一段没有空格的咒文">
        召唤真名:Aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
      </Blockquote>
      ...
      <Blockquote
        cite="一个长到离谱的出处来源名称——来自某个嵌套很深的星界图书馆分馆目录索引条目"
        citeUrl="https://magic-scope.dev/very/deeply/nested/arcane/library/catalogue/index/entry?ref=infinite-scroll-of-doom"
      >
        出处再长,也不该把引用框撑变形。
      </Blockquote>
    </div>
