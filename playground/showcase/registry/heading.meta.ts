...
export const meta: ComponentMeta = {
  ...
  name: 'Heading',
  category: 'typography',
  summary: '语义标题 h1–h6,视觉与语义解耦(level 定标签、variant 定视觉),魔法渐变/辉光/anchor。',
  description:
    '自研、复用 Text 的字族/tone/字重/对齐/截断/折行能力。\nlevel 定语义标签(h1–h6,可访问性大纲),variant 定视觉档(display/title/subtitle/overline/caption),二者独立(MUI 式)。\n标题默认 text-wrap:balance 多行均衡;支持渐变(可 aurora 流光)、辉光(受全局光影开关调制)、permalink anchor(CJK 友好 slug)。',
  controls: [
    {
      type: 'select',
      prop: 'level',
    ...
    { type: 'text', prop: 'children', label: '文案', default: '奥术标题 ✦ Arcane Heading' },
  ],
  spread: 'h2',
};
