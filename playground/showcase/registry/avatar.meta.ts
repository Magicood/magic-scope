  ...
  controls: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'busy', label: 'busy 忙碌' },
        { value: 'away', label: 'away 离开' },
      ],
    },
    {
      type: 'select',
    ...
    { type: 'boolean', prop: 'statusPulse', label: '状态脉冲 statusPulse', default: false },
    { type: 'boolean', prop: 'ring', label: '光环 ring', default: false },
    { type: 'boolean', prop: 'bordered', label: '边框 bordered', default: false },
