<div class="ms-demo">
  <ol class="ms-timeline ms-timeline--left" style="max-inline-size: 26rem;">
    <li class="ms-timeline__item ms-timeline__item--toned ms-tone-success">
      <div class="ms-timeline__node" aria-hidden="true"><span class="ms-timeline__dot"></span><span class="ms-timeline__line" aria-hidden="true"></span></div>
    ...
    <li class="ms-timeline__item ms-timeline__item--toned ms-tone-primary">
      <div class="ms-timeline__node" aria-hidden="true"><span class="ms-timeline__dot"></span><span class="ms-timeline__line" aria-hidden="true"></span></div>
      <div class="ms-timeline__content">
    ...
    <li class="ms-timeline__item ms-timeline__item--toned ms-tone-warning">
      <div class="ms-timeline__node" aria-hidden="true"><span class="ms-timeline__icon">!</span><span class="ms-timeline__line" aria-hidden="true"></span></div>
      <div class="ms-timeline__content">
    ...
    <li class="ms-timeline__item">
      ...
      <div class="ms-timeline__content">
        ...
        <div class="ms-timeline__body">默认变体(中性节点),末项不画连线。</div>
      </div>
    </li>
  </ol>
</div>
